  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center space-y-12 px-4 md:px-8 lg:px-16">
      <motion.h1 
        ...
        className="text-3xl md:text-5xl mt-10 font-mono tracking-widest bg-gradient-to-l from-indigo-600 via-purple-600 to-violet-600 dark:from-indigo-400 dark:via-purple-400 dark:to-violet-400 bg-clip-text text-transparent font-extrabold"
      >
        Projects
      </motion.h1>
      ...
      <div className="w-full max-w-7xl mx-auto space-y-12">
        ...
        <motion.div
          ...
          viewport={{ once: false, amount: 0.3 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="w-full max-w-[900px] h-[250px] rounded-3xl flex items-center justify-center border-2 border-dashed border-white/20 text-white/60 text-xl tracking-widest hover:scale-[1.03] transition-all duration-900 ease-in-out mx-auto"
        >
