...
function Contact() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-white p-4 md:p-6">
      <form onSubmit={handleSubmit} className="bg-gradient-to-br from-white/10 to-white/10 dark:from-gray-800/0 dark:to-gray-900/50 border border-white/50 dark:border-gray-700/10 shadow-2xl font-mono tracking-wide p-6 md:p-8 rounded-2xl shadow-xl w-full max-w-[800px] min-h-[700px]">
